...
#define IR_TARGET 210 // if the robot is too close, input will be higher than threshold
#define kP_IR 2.2
#define kD_IR 0.8
...
int16_t r_values[7] = {0, 336, 335, 222, 246, 361, 271};
int16_t g_values[7] = {0, 613, 485, 530, 572, 550, 517};
int16_t b_values[7] = {0, 521, 393, 390, 508, 410, 454};
